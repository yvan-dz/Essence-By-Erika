    ...
    jQuery(document).ready(function () {
        ...
        $('[data-countdown]').each(function () {
            ...
            $this.countdown(finalDate, function (event) {
                $this.html(event.strftime('<div class="count"><p>%D</p><span>Jours</span></div><div class="count"><p>%H</p> <span>Heure(s)</span></div><div class="count"><p>%M</p> <span>Min</span></div><div class="count"> <p>%S</p> <span>Sec</span></div>'));
            });
        });
    });
