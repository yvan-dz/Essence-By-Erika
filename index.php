...
<head>
    ...
    <title>Essence By Erika - Acceuil</title>
                            ...
                            <ul class="nav  best__selling__tab__wrap" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="product__tap__link active" data-bs-toggle="tab"
                                        data-bs-target="#projects__one" type="button">Hommes</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="product__tap__link" data-bs-toggle="tab"
                                        data-bs-target="#projects__two" type="button">Femmes</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="product__tap__link" data-bs-toggle="tab"
                                        data-bs-target="#projects__three" type="button">Mixtes</button>
                                </li>
                        ...
                        <div class="feature__border">
                            <div class="feature__2__single feature__3__single">
                                ...
                                <div class="feature__2__text">
                                    ...
                                    <p>Sur les commandes excedants 99.99€</p>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="section__title text-center">
                        ...
                        <p><a href="#" target="_blank" title="https://www.instagram.com/">@erik_aash</a></p>
                    </div>
                </div>
            </div>
